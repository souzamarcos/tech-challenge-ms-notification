...
public class DefaultOrderService implements OrderService {
    ...
    public Order findById(OrderRepository orderRepository, Long id) {
    ...
    public List<Order> findAllBy(OrderRepository orderRepository, OrderStatus status) {
        if (status == null) return orderRepository.findAll();
        return orderRepository.findAllBy(status);
    }

    public List<Order> findAllInProgress(OrderRepository orderRepository) {
        return orderRepository.findAllInProgress();
    }

    public Order insert(OrderRepository orderRepository, ProductRepository productRepository,
                        ClientRepository clientRepository, Order order) {
        Client client = getClient(clientRepository, order);
    ...
    public Order checkout(OrderRepository orderRepository, Long orderId) {
    ...
    public Order updateStatus(OrderRepository orderRepository, Long orderId, OrderStatus newStatus) {
        var order = orderRepository.findById(orderId);
    ...
    private Client getClient(ClientRepository clientRepository, Order order) {
